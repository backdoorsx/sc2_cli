...
class Core:
            ...
            while True:
                ...
                if choose.isnumeric():
                    ...
                    if choose < len(datax):
                        ...
                        return None, None
                elif choose.upper() == 'B' or choose.upper() == 'BACK':
                    return None, None
                ...
                if choose.isnumeric():
                    ...
                    if choose == 99:
                        ...
                        if all_data == 'episode':                       # serial nema serie
                            ...
                            if len(all_data) == 1:
                                season = input(f'{SN}{datax[choose][1]} | Choose number [AUTO = 0] > ') # INPUT
                            else:
                                season = input(f'{SN}{datax[choose][1]} | Choose number > ') # INPUT
                            
                            if len(all_data) == 1 and season == '':
                                season = '0'
    ...
    def sort(movie_name, streams_data):
        ...
        while True:
            ...
            if auto.isnumeric():
                stream_choose = input(f'{SN}{movie_name} [AUTO = {auto}] > ')      # INPUT
            else:
            ...
            if stream_choose.isnumeric():
                ...
                if stream_choose == 99:
                    ...
                    return 0
            elif stream_choose == '' and auto.isnumeric():
                auto = int(auto)
                ident_stream = streams_data[auto][0]
                Core.link(ident_stream, movie_name, streams_data[auto])
                return 0
