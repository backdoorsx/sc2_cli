        ...
        while True:
            ...
            if name == '99':
                ...
                for i in range(len(datax_reverse)):
                    print('  '+'+'+76*'-')
                    if i >= 10:
                        print('  |  {}  |  {}  |  {}'.format(datax_reverse[i][0], datax_reverse[i][1], datax_reverse[i][2]))
                    else:
                        print('  |  {}   |  {}  |  {}'.format(datax_reverse[i][0], datax_reverse[i][1], datax_reverse[i][2]))
                        ...
                        if season.isnumeric():
                            ...
                            if season == 99:
                                ...
                                for i in range(len(e_data)):
                                    ...
                                    print('  '+'+'+76*'-')
                                    if i < 10:
                                        print('  |  {}   |{}|  {}  |  {} {}'.format(i+1, seen, e_data[i][1], e_data[i][2], waiting))
                                    else:
                                        print('  |  {}  |{}|  {}  |  {} {}'.format(i+1, seen, e_data[i][1], e_data[i][2], waiting))
                                ...
                                episode = input('\n   {} | Season{} | Choose number [{}-{}] > '.format(datax[choose][1], all_data[season][2],1 ,len(e_data) )) # INPUT
    ...
    def sort(movie_name, streams_data):
        ...
        for s in range(len(streams_data)):                          # ident size video audio
            ...
            if len(stream_isva[2]) > 0:
                ...
                print('  | {}{}\t{}\t{}'.format(space, s, quality, size))
                print('  | {}\t{}\t{}\t{}'.format(empty, video_width, audio_data, sub_data))
            ...
            if menu == '0':
                ...
                while True:
                    ...
                    while n<len(all_episode):
                        ...
                        nxt = input('  Next episode {} ? [yes/no/retry] > '.format(all_episode[n][2]))
                        print(serial_name)
